...
protectedRouter.POST("/category/create", "Create a new category", func(c *gin.Context) {
	...
	protectedRouter.POST("/npc-character/create", "Create an NPC character", func(c *gin.Context) {
		Controllers.CreateNpcCharacter(c, Services.DB)
	})
	protectedRouter.POST("/npc-character/update/:id", "Update an NPC character by ID", func(c *gin.Context) {
		Controllers.UpdateNpcCharacter(c, Services.DB)
	})
